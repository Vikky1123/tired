                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="ui"  data-parent="#sidebar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="../ui-elements/ui-boxshadow.html">
                                    <i class="icon">
                                       <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="../ui-elements/ui-helper-classes.html">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>
      ...
      <footer class="footer">
          <div class="footer-body gap-2">
              <ul class="left-panel list-inline mb-0 p-0">
                  <li class="list-inline-item me-2"><a href="privacy-policy.html" class="text-white">Privacy Policy</a></li>
                  <li class="list-inline-item"><a href="terms-of-service.html" class="text-white">Terms of Use</a></li>
              </ul>
