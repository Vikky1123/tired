...
<div class="row">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="fw-bold mb-3">Keep an eye on Bitcoin</h1>
                            <p>Every four years, the bitcoin rewards are slashed in half. Find out why on the Halving page.</p>
                            <button type="button" class="btn btn-primary mt-5">Bitcoin Halving Page</button>
                        </div>
                    </div>
                    <div class="col-lg-6 text-center academy-img">
                    </div>
                </div>
                <div class=" vertical-scroll vertical-scroll-res text-center">
                        <img src="../assets/images/special-pages/academy/01.png" class="img-fluid w-30" alt="img1">
                </div>
            </div>
        </div>
   </div>
         ...
         <div class="col-lg-12">
             <div class="d-flex justify-content-between py-4">
                ...
                <div class="text-primary">
                    <div class="dropdown d-flex" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                        View all
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 20 20" fill="currentColor" class="ms-1">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <img src="../assets/images/special-pages/academy/1.png" class="img-fluid " alt="img8">
                            <div class="mt-4">
                                <span type="button" class="d-flex align-items-center">
                                <svg width="7" class="me-1 text-center" viewBox="0 0 7 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="3.5" cy="4" r="3.5" fill="#ff971d"/>
                                </svg><span class="text-primary ms-1">Beginner</span></span>
                            </div>
                            <h6 class="mt-3 mb-0">What Are NFT Games and How Do They Work?</h6>
                        </div>
                        <div class="card-body d-flex  align-items-center gap-4">
                    
                            <p class="ms-1 mb-0">Sep 2,2021</p>                           
                            <div class="d-flex align-items-center ">
                                
                                <p class="ms-1 mb-0">5m</p>                        
                            </div>
                        </div>
                    </div>                    </div>
                    <div class="swiper-slide">
                    <div class="card">
                        <div class="card-header">
                            <img src="../assets/images/special-pages/academy/2.png" class="img-fluid " alt="img8">
                            <div class="mt-4">
                                <span type="button" class="d-flex align-items-center">
                                <svg width="7" class="me-1 text-center" viewBox="0 0 7 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="3.5" cy="4" r="3.5" fill="#ff971d"/>
                            ...
                            <h6 class="mt-3 mb-0">What are other functions of crypto currencies?</h6>
                        </div>
                        <div class="card-body d-flex  align-items-center gap-4">
                    
                            <p class="ms-1 mb-0">Sep 2,2024</p>                           
                            <div class="d-flex align-items-center ">
                                
                                <p class="ms-1 mb-0">8m</p>                        
                            </div>
                        </div>
                    </div>                    </div>
                    <div class="swiper-slide">
                    <div class="card">
                        <div class="card-header">
                            <img src="../assets/images/special-pages/academy/3.png" class="img-fluid " alt="img8">
                            <div class="mt-4">
                                <span type="button" class="d-flex align-items-center">
                                <svg width="7" class="me-1 text-center" viewBox="0 0 7 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="3.5" cy="4" r="3.5" fill="#ff971d"/>
                            ...
                            <h6 class="mt-3 mb-0">What Is QuickSwap and How Does It Work?</h6>
                        </div>
                        <div class="card-body d-flex  align-items-center gap-4">
                    
                            <p class="ms-1 mb-0">Feb,2023</p>                           
                            <div class="d-flex align-items-center ">
                                
                                <p class="ms-1 mb-0">6m</p>                        
                            </div>
                        </div>
                    </div>                    </div>
                    <div class="swiper-slide">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex  align-items-center gap-4">
                            ...
                            <p class="ms-1 mb-0">Jan 21,2021</p>                           
                            <div class="d-flex align-items-center ">
         ...
         <div class="col-lg-12">
              <div class="card">
                    <div class="card-body row">
                        <div class="col-lg-6 d-flex justify-content-between align-items-center">
                            <div class="">
                                <h2 class="mb-3">Blockchain & Crypto</h2>
                                <p>Every four years, the bitcoin rewards are slashed in half. Find out why on the Halving page.Every four years, the bitcoin rewards are slashed in half.</p>
                                <button type="button" class="btn btn-primary mt-4">Start Here </button>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-lg-0 mt-4">
                            <div class="scrolling-text1 vertical-scroll1 vertical-scroll-res1 text-center">
                                <div>
                                    Crypto
                                </div>
                            </div>
                            <img src="../assets/images/special-pages/academy/01.png" class="img-fluid" alt="img8">
                        </div>
                    </div>
                </div>
         </div>
               ...
               <div class="swiper-container d-slider2">
                  <div class="swiper-wrapper">
                     <div class="swiper-slide">
                        <div class="card">
                            <div class="card-header">
                                <img src="../assets/images/special-pages/academy/4.png" class="img-fluid " alt="img8">
                                <div class="mt-4">
                                    <span type="button" class="d-flex align-items-center">
                                    <svg width="7" class="me-1 text-center" viewBox="0 0 7 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="3.5" cy="4" r="3.5" fill="#ff971d"/>
                                ...
                                <h6 class="mt-3 mb-0">What is a Market Order &amp; how can you order FNO?</h6>
                            </div>
                            <div class="card-body d-flex  align-items-center gap-4">
                        
                                <p class="ms-1 mb-0">Jun 12,2018</p>                           
                                <div class="d-flex align-items-center ">
                     ...
                     <div class="swiper-slide">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h6 class="mt-3 mb-0">What is Shorting in the Financial Markets?</h6>
                            </div>
                            <div class="card-body d-flex  align-items-center gap-4">
                        
                                <p class="ms-1 mb-0">Nov 18,2020</p>                           
                                <div class="d-flex align-items-center ">
                     ...
                     <div class="swiper-slide">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h6 class="mt-3 mb-0">What is the Risk/Reward Ratio and How to use it?</h6>
                            </div>
                            <div class="card-body d-flex  align-items-center gap-4">
                        
                                <p class="ms-1 mb-0">Oct 10, 2019</p>                           
                                <div class="d-flex align-items-center ">
                     ...
                     <div class="swiper-slide">
                        <div class="card">
                            ...
                            <div class="card-body d-flex  align-items-center gap-4">
                                ...
                                <p class="ms-1 mb-0">Aug 1,2024</p>                           
                                <div class="d-flex align-items-center ">
                     ...
                     <div class="swiper-slide">
                        <div class="card">
                            ...
                            <div class="card-body d-flex  align-items-center gap-4">
                                ...
                                <p class="ms-1 mb-0">Sep 30,2022</p>                           
                                <div class="d-flex align-items-center ">
                     ...
                     <div class="swiper-slide">
                        <div class="card">
                            ...
                            <div class="card-body d-flex  align-items-center gap-4">
                                ...
                                <p class="ms-1 mb-0">Feb 13,2025</p>                           
                                <div class="d-flex align-items-center ">
   ...
   <div class="col-lg-4">
      <div class="col-lg-12">
        <div class="card">
            <div class="card-header border-bottom py-4 px-0 mx-4 ps-2">
                <div class="header-title">
                <div class="d-flex  justify-content-between">
                    <h4 class="card-title">List</h4>
                        <div class="text-primary">
                            <div class="dropdown" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false" role="button">
                                View all
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                </svg>
      ...
      <div class="col-md-12 banner-horizontal">
            <div class="iq-video-thumb">            
                <img src="../assets/images/special-pages/academy/3.png" class="img-fluid rounded-2  w-100" alt="img8">
                <button type="button" class="iq-btn-thumb btn btn-icon text-primary rounded-circle">
                <span class="btn-inner">
                    <svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.8817 9.20912C14.5492 8.3891 12.8335 9.3478 12.8335 10.9124V33.0875C12.8335 34.6522 14.5492 35.6109 15.8817 34.7908L33.8989 23.7033C35.168 22.9223 35.168 21.0776 33.8989 20.2967L15.8817 9.20912Z" fill="currentColor"/>
                    </svg>
                </span>
                </button>
            </div>
