...
/**
 * Dashboard page
 * Shows personalized dashboard for logged-in user
 */
...
if ((!$userId || !$userData) && ($refererIsLoginPage || $skipAllRedirects)) {
    // We'll continue to show the dashboard with an error message
    $authError = false; // Set to false to prevent showing error banner
} else {
    $authError = false;
}

// Get user financial data (if user is authenticated)
...
$total_deposit = isset($financialData['total_deposit']) ? $financialData['total_deposit'] : 0;
$total_withdrawal = isset($financialData['total_withdrawal']) ? $financialData['total_withdrawal'] : 0;
...
$formattedDeposit = $authError ? '0.00' : number_format($total_deposit, 2);
$formattedWithdrawal = $authError ? '0.00' : number_format($total_withdrawal, 2);
...
<head>
    <meta charset="utf-8">
      ...
      <!-- Disable the auth-check script to prevent redirect loops -->
      <!-- <script src="absolute-auth-check.js"></script> -->
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          // Authentication error banner removed
      });
      </script>
    </head>
  <body class=" ">
    ...
    <aside class="sidebar sidebar-default navs-rounded ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../../../bitrader.thetork.com/main%20page%20folder/index.html" class="navbar-brand dis-none align-items-center">
                <img src="assets/images/logo.svg" class="img-fluid" alt="logo">
                <h4 class="logo-title m-0">COINEX</h4>
            </a>
                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="app/user-profile.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" width="16" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="7.5" stroke="currentColor"></circle>                                                                    
                                        </svg>                          
      ...
      <div class="position-relative">
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar border-bottom pb-lg-3  pt-lg-3 ">
          <div class="container-fluid navbar-inner">
            <a href="../../../bitrader.thetork.com/main%20page%20folder/index.html" class="navbar-brand">
            </a>
            <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
                <i class="icon">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title"><?php echo htmlspecialchars($userData['full_name'] ?: $userData['username']); ?></h6>
                        <p class="mb-0 caption-sub-title"><?php echo htmlspecialchars($userData['email']); ?></p>
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li class="border-0"><a class="dropdown-item" href="app/user-profile.php">Profile</a></li>
                        ...
                        <div class="d-none d-lg-block w-50">
                           <div class="d-flex justify-content-between align-items-start gap-4">
                              <div class="text-center">
                                 <h5 class="mb-2" id="total-balance"><?php echo $formattedBalance; ?></h5>
                                 <p class="mb-0 text-muted">Total Balance</p>
                              </div>
                              <div class="text-center">
                                 <h5 class="mb-2" id="total-profit"><?php echo $formattedProfit; ?></h5>
                                 <p class="mb-0 text-muted">Total Profit</p>
                              </div>
                              <div class="text-center">
                                 <h5 class="mb-2" id="total-deposit"><?php echo $formattedDeposit; ?></h5>
                                 <p class="mb-0 text-muted">Total Deposit</p>
                              </div>
                              <div class="text-center">
                                 <h5 class="mb-2" id="total-withdrawal"><?php echo $formattedWithdrawal; ?></h5>
...
<div class="row pt-2">
               ...
               <div class="col-lg-4">
                  <div class="card shining-card">
                     <div class="card-body">
                        ...
                        <div class="pt-3">
                           <h4 class="counter" id="btc-balance" style="visibility: visible;">$0.00</h4>
                           <div class="pt-3">
                  ...
                  <div class="card shining-card">
                     <div class="card-body">                    
                        ...
                        <div class="progress-detail pt-3">
                           <h4 class="counter" id="dash-balance" style="visibility: visible;">$0.00</h4>
                           <div class="pt-3">
               ...
               <div class="col-lg-4">
                  <div class="card shining-card">
                     <div class="card-body">                    
                        ...
                        <div class="progress-detail pt-3">
                           <h4 class="counter" id="eth-balance" style="visibility: visible;">$0.00</h4>
                           <div class="pt-3">
   ...
   <div class="col-lg-4">
    ...
    <script src="assets/js/coinex.min862f.js?v=4.1.0"></script>  
