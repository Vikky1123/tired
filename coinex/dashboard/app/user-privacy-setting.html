                            ...
                            <div class="acc-privacy">
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label mb-2" for="acc-private">Private Account</label>
                                    </div>
                                    <p>When enabled, your account and trading activity will only be visible to users you approve. Your profile will not appear in public searches.</p>
                                </div>
                                <hr>
                                <div class="data-privacy">
                                    ...
                                    <p>Shows other users when you're active on the platform. Turning this off will hide your online status and last active time from other users.</p>
                                </div>
                                <hr>
                                <div class="data-privacy">
                                    ...
                                    <p>Permits other users to share your market analysis, trading insights, and portfolio updates to their own networks. Disable to keep your content restricted to your approved followers.</p>
                                </div>
                                <hr>
                                <div class="data-privacy">
                                    ...
                                    <p>Controls how your profile photo is managed. Automatic mode allows the system to update your photo when you change it on linked platforms. Manual mode requires your approval before any changes are made.</p>
                                </div>
                                <hr>
                                <div class="data-privacy">
                                    ...
                                    <p>Set who can view your cryptocurrency portfolio, trading history, and investment strategies. Public visibility maximizes your networking potential, while restricted options provide greater privacy and security. Choose based on your comfort level with sharing financial information.</p>
                                </div>
                                <hr>
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check mb-2">
                                        <input type="radio" id="disable" name="customRadio2" class="form-check-input"
                                            checked="">
                                        <label class="form-check-label" for="disable"> Disable </label>
                                    </div>
                                    <p>Receive alerts when your account is accessed from a new device or location. This critical security feature helps protect your cryptocurrency assets by providing immediate notification of potentially unauthorized access attempts.</p>
                                </div>
                                <hr>
                                <div class="data-privacy">
                                    ...
                                    <a href="#" class="text-primary">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                            <g>
                                            <path  d="M5 9C5 -0.333334 19 -0.333334 19 9" stroke="currentcolor" stroke-width="2"/>
                                            <path  d="M9 16.1596C10.8666 17.331 13.1734 17.2778 15 16" stroke="currentcolor" stroke-width="2" stroke-linecap="round"/>
                                            <path  d="M12 22C16.6667 22 19 18.5 19 15" stroke="currentcolor" stroke-width="2" stroke-linecap="round"/>
                                            <rect  x="18" y="9" width="2" height="6" fill="currentcolor"/>
                                            <path  d="M19 9H21C22.1046 9 23 9.89543 23 11V13C23 14.1046 22.1046 15 21 15H19V9Z" stroke="currentcolor" stroke-width="2"/>
                                            <path  d="M1 11C1 9.89543 1.89543 9 3 9H5V15H3C1.89543 15 1 14.1046 1 13V11Z" stroke="currentcolor" stroke-width="2"/>
                                            <path  d="M4 9H6V15H4V9Z" fill="currentcolor"/>
                                            </g>
                                            </g>
                                        </svg>
                                    Support</a>
                                ...
                                <div class="text-center mt-3">
                                    <button type="button" class="btn btn-primary" onclick="window.location.href='../index.html'">Save Changes</button>
                                </div>
                            </div>
                        </div>
                    </div>
