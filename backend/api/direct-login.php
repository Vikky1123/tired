...
try {
    ...
    if (!isset($data['username']) || !isset($data['password'])) {
        throw new Exception("Missing required fields: username and password");
    }
    
    // Forward the request to the actual login file
    $login_path = __DIR__ . '/auth/login.php';
    if (!file_exists($login_path)) {
        throw new Exception("Login handler file not found at: $login_path");
    }
